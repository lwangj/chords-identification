...
LABELS = ["blancas", "clave_fa", "corchea", "sol"]  # UPDATE ME!!!!
...
def live_test(model_path):
    ...
    with get_engine("no", model_path) as engine, engine.create_execution_context() as context:
	    ...
	    # Line thickness of 2 px
            thickness = 1
            frame=orig_frame[222:798,222:798,:]
            orig_frame = cv2.rectangle(orig_frame, start_point, end_point, color, thickness)
            ...
            cv2.imshow('Prediction Music Score. Realized by: Antonio Jesus Perez & Lu Wang', orig_frame)
